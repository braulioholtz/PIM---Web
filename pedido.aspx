...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="col-md-12">
        <asp:Wizard ID="wzPedido" runat="server" Width="100%" ActiveStepIndex="1" FinishCompleteButtonText="Finalizar" StepNextButtonText="Próximo" StartNextButtonText="Próximo" DisplaySideBar="False" OnFinishButtonClick="wzPedido_FinishButtonClick">
            ...
            <WizardSteps>
                ...
                <asp:WizardStep runat="server" Title="Finalizar Pedido" StepType="Finish">
                    ...
                    Os itens do pedido são<br /> - sads<br /> - fsdfds<br />
                </asp:WizardStep>
